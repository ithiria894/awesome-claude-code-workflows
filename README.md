...
- [Ariadne Loop](https://github.com/zhangzeyu99-web/ariadne-loop) - Turns rough task context into a verifiable inspect-act-verify-decide loop contract, combining a Claude Code command or skill with local packet templates, verifier gates, stop rules, rollback rules, and JSON report supervision.
